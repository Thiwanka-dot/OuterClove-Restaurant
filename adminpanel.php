...
<body>
    <div class="box">
        ...
        <div class="contain">
            ...
            <div class="btn"><a href="addProducts.php" style="color: #fff; text-decoration: none;">Add Products</a></div>
            ...
            <div class="btn"><a href="viewStaffs.php" style="color: #fff; text-decoration: none;">View Staff Members</a></div>
